...
// Startup code for the executable 'audio'.
...
LE_SHARED const char* _myAudio_le_audio_ServiceInstanceName = "audio.myAudio.le_audio";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t audio_exe_LogSession;
LE_SHARED le_log_Level_t* audio_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    audio_exe_LogSession = log_RegComponent("audio_exe", &audio_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_myAudio.so");
