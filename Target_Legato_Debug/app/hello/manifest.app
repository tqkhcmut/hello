...
<app:application xmlns:app="http://www.sierrawireless.com/airvantage/application/1.0" name="hello" type="" revision="1.0.0">
  <application-manager use="LWM2M_SW"/>
  <capabilities>
    <communication use="legato"/>
    <data>
      <encoding type="LWM2M">
        <asset default-label="Application Objects" id="le_hello">
